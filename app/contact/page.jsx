          ...
          <div className="xl:h-[54%] order-2 xl:order-none">
            <form className="flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl">
              ...
              <p className="text-white/60">
                I&apos;m passionate about building user-friendly, scalable web applications. Whether you need a responsive website, a custom full-stack solution, or UI implementation from design files—I’m ready to bring your ideas to life.
              </p>
              {/* input */}
